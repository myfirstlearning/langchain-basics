...
speech_prompt = PromptTemplate(
    ...
    template="""You need to write a powerful {emotion} speech of 350 words on the following title: {title}
    """
)
...
if topic:
    with st.spinner(f"Generating speech on {topic} with {emotion}..."):

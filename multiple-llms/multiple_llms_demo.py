...
gpt_llm = ChatOpenAI(model="gpt-4o", api_key=OPEN_API_KEY)
...
google_gemini_llm = ChatGoogleGenerativeAI(model="gemini-2.5-pro",
...
first_chain = title_prompt | gpt_llm | StrOutputParser() | (lambda title: (st.write(title), title)[1])
# use multiple LLMs
second_chain = speech_prompt | google_gemini_llm # use Google Gemini LLM
